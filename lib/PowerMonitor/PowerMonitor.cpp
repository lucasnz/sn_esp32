...
void PowerMonitor::loop() {
    ...
    debugD("Current (A): %lf, Power (W): %lf, diff: %u, _offset: %lf, energyConsumed: %lf, lastMinuteIndex: %i, _minuteEnergy: %lf, _powerConsumedLastHour: %lf", _instantaneousCurrent, _instantaneousPower, diff, _offset, energyConsumed, lastMinuteIndex, _minuteEnergy[lastMinuteIndex], _powerConsumedLastHour);
}
